...
echo "gradlew deploy..."
(cd $XP_ROOT/source && ./gradlew clean deploy)

(chmod -R 777 $XP_ROOT/source/node_modules/ \
	$XP_ROOT/source/src/main/resources/assets/js \
	$XP_ROOT/source/src/main/resources/assets/css \
	$XP_ROOT/source/src/main/resources/assets/libs \
	$XP_ROOT/source/package-lock.json \
	$XP_ROOT/source/build)

echo "Starting Enonic xp..."
cd $XP_ROOT/bin ; ./server.sh dev $@
